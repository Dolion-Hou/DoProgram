...
@implementation DOHComponentModel

//- (void)setComponentArrays:(NSMutableArray *)componentArrays{
//    [self setValue:componentArrays forKey:@"componentArrays"];
//}
//
//- (NSMutableArray *)componentArrays{
//    DOHComponentDetailModel *componentDetailModel= [[DOHComponentDetailModel alloc] init];
//    componentDetailModel.componentImageName = componentImageNames[1];
//    componentDetailModel.componentNmae = componentNmaes[1];
//    [self.componentArrays addObject:componentDetailModel];
//    return self.componentArrays;
//}

@end


@implementation DOHComponentDetailModel
